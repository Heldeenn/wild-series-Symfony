...
class Program
{
     ...
     *     maxMessage="La champ saisie {{ value }} est trop long, il ne devrait pas dépasser {{ limit }} caractères",
     ...
     * @Assert\NotBlank(message="Le champ résumé ne doit pas être vide.")
     */
    private $summary;
